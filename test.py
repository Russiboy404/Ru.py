...
def banner():
        os.system("clear")
        print('[+] AUTHOR   : Muhamad_hax0r')
        print('[+] Tlegram : Haxor_decypter')
        print('[+] Note : FREE')
        print('[+] facebook id clone')
def cek_dev():
...
def genkey():
	try:
		rn = open('https://github.com/Russiboy404/Ru.py''').read()
		rb = rn+basesplit
		banner()
		psb('       %s》%s》%s》%sWelcome%s《%s《%s《'%(M,H,B,H,B,H,M))
		print("\n\033[0;91m           Key 15$ | 1mang ")
		print("\033[0;93m            SEND Key @Muhamad_hax0r\n\n   YOUR KEY : \033[0;92m%s"%(rb))
		print("\033[0;93m   Note : %s15$ "%(H))
		print("\033[0;93m   15$ : %s1mang"%(H))
		print("\033[0;94m          TELEGRAM me : @Muhamad_hax0r")
		print("\033[0;94m \n\n")
		subprocess.check_output(["am", "start", "https://t.me/Muhammed_hax0r"])
		exit()
	except(IOError):
		rb = rx
		open("https://github.com/Russiboy404/Ru.py").write(rb)
		os.system("https://github.com/Russiboy404/Ru.py")
		banner()
		psb('       %s》%s》%s》%sWelcome%s《%s《%s《'%(M,H,B,H,B,H,M))
		print("\n\033[0;91m              Key 15% | 1mang")
		print("\033[0;93m               SEND Key : @Muhamad_hax0r \n\n YOUR KEY : \033[0;92m%s%s"%(rb,basesplit))
		print("\033[0;93m     Note : %s15$"%(H))
		print("\033[0;93m     15$ : %s1 mang"%(H))
		print("\033[0;94m             TELEGRAM me : @Muhamad_hax0r")
		print("\033[0;94m \n\n")
		subprocess.check_output(["am", "start", "https://t.me/Muhammed_hax0r"])
		exit()
...
def keycheck():
    try:
        k = open("https://github.com/Russiboy404/Ru.py").read()
